    ...
    return (
        <div className="footer p-[5rem] mb-4 bg-blueColor rounded-[10px] gap-8 grid grid-cols-5 m-auto items-start justify-center">
            <div>
                ...
                <p className="text-white pb-[13px] opacity-70 leading-7">We always make our seekers and companies find the best job and employers find the best candidates</p>
            </div>
            ...
            <div className="grid">
                ...
                <div className="">
                    <small className="text-white text-[15px]">
                        sawonhossain3491@gmail.com
                    </small>
                    <div className="icons flex gap-4 py-4">
                        <AiFillInstagram className='bg-white p-5 w-[36px] h-[36px] rounded-full icon text-black' />
                        <BsFacebook className='bg-white p-5 w-[36px] h-[36px]  rounded-full icon text-blueColor' />
                        <AiOutlineTwitter className='bg-white p-5 w-[36px] h-[36px]  rounded-full icon text-blueColor' />
                    </div>
                </div>
            </div>
        </div>
